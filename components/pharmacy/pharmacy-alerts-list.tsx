...
export function PharmacyAlertsList() {
  const { toast } = useToast()
  const [alerts, setAlerts] = useState([
    {
      id: "alert-1",
      title: "Critical Inventory Alert",
      description: "Amoxicillin 500mg is below critical threshold (45 units remaining).",
      time: "10 minutes ago",
      severity: "critical",
      type: "inventory",
      acknowledged: false,
    ...
    },
    {
      ...
      description: "15 medications will expire within 90 days.",
      time: "1 hour ago",
      severity: "info",
      type: "inventory",
      acknowledged: false,
    },
    {
      ...
      description: "Order #ORD-2024-0128 for Lisinopril has been confirmed.",
      time: "2 hours ago",
      severity: "success",
      type: "order",
      acknowledged: true,
